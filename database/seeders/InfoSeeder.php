...
class InfoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Info::create(['option' => 'website_name_en','value' => 'مؤسسة العسكر','type' => 'string']);
        Info::create(['option' => 'website_name_ar','value' => 'مؤسسة العسكر','type' => 'string']);
        ...
        Info::create(['option' => 'about_us_ar','value' => 'مؤسسة العسكر للمقاولات العامة','type' => 'text']);
