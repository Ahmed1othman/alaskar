...
return [
    'meta' => [
         ...
         */
        'defaults'       => [
            'title'        => 'مؤسسة صالح عبدالرحمن العسكر للمقاولات والعوازل', // set false to total remove
